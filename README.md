...
### Linux and macOS (and also Windows)
...
Note that the above Linux and macOS install command *does* build from source, so if you don't plan on modifying the code, there's no need to do this.
```sh
